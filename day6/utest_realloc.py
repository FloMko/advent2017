...
class CapTest(unittest.TestCase):
    ...
    def test_case_equal(self):
        """detect loop"""
        print ( "id: " + self.id())
        self.assertEqual(realloc.detect([0,2,7,7],[[0,2,7,6],[0,2,7,7]]), False)
    def test_case_distribute(self):
        """detect loop"""
        print ( "id: " + self.id())
        self.assertEqual(realloc.distribute([2,3,0,0],1,3),[3,0,1,1])
    def test_case_aknowleged(self):
        """detect loop"""
        print ( "id: " + self.id())
        self.assertEqual(realloc.aknowleg([[2,3,0,0],[2,4,7,7]]),[[[2,3,0,0],[2,4,7,7]]])
